const iconShebang = new URL('../assets/svg/icon-shebang.svg', import.meta.url);

export function TapBox() {
	return (
		<button>
			{/* <img src={iconShebang.toString()} alt="Tap" /> */}
			<svg width="196" height="178" viewBox="0 0 196 178" fill="#111" xmlns="http://www.w3.org/2000/svg">
